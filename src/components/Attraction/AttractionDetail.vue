  ...
  <div class="max-w-7xl mx-auto py-10 flex flex-col mt-20">
    ...
    <div class="flex justify-between">
      <div class="flex py-3 text-lg">
        <Score
          :score="
            attractionInfo.rating && attractionInfo.rating.length > 0
              ? attractionInfo.rating.reduce((a, b, i) => a + b * (i + 1), 0) /
                attractionInfo.rating.reduce((a, b) => a + b, 0)
              : 0
          "
        />
        <p class="ml-5">
          {{ attractionInfo.rating ? attractionInfo.rating.reduce((a, b) => a + b, 0) : 0 }} 건의
          리뷰
        </p>
      ...
      <div class="flex flex-col justify-between p-4 leading-normal h-[30rem]" style="width: 50%">
        <div class="flex justify-between">
          ...
          <div class="flex gap-3">
            ...
            <a
              :href="
                'https://www.instagram.com/explore/tags/' + attractionInfo.title.replace(' ', '')
              "
              target="_blank"
            ...
            <a
              :href="'https://www.youtube.com/results?search_query=' + attractionInfo.title"
              target="_blank"
              class="mt-1"
            >
              <svg
            ...
            <Wish
              ...
              v-if="!attractionInfo.wishlistId && userInfo"
            />
            <Wished
              :contentId="attractionInfo.contentId"
              v-if="attractionInfo.wishlistId && userInfo"
