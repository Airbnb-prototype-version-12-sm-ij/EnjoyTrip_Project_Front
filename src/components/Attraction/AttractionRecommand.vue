...
<template>
  <div id="default-carousel" class="mt-40 relative max-w-screen" data-carousel="slide">
    ...
    <div class="relative overflow-hidden rounded-lg md:h-[50vh] max-h-screen aspect-video">
      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
        <img
          src="@/assets/attractionRecommand/광주.jpeg"
          class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          alt="..."
        />
      </div>
      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
        <img
          src="@/assets/attractionRecommand/강릉.jpeg"
          class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          alt="..."
        />
      </div>
      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
        <img
          src="@/assets/attractionRecommand/부산.jpeg"
          class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          alt="..."
        />
      </div>
      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item>
        <img
          src="@/assets/attractionRecommand/제주도.jpeg"
          class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          alt="..."
        />
      </div>
