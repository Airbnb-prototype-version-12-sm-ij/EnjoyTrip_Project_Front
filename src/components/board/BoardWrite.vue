...
const onSubmit = (e) => {
  ...
  client.post('/posting/write', formData, {
    headers: {
        ...
        <div class='flex'>
          <div>
            ...
            <select id="sidoCode" name='sidoCode' v-model='sidoCode'>
              <option v-for="item in regionData" :key="regionData" :value='item.id'>{{ item.name }}</option>
            </select>
          </div>
          ...
          <div>
            ...
            <Select id="gugunCode" name='gugunCode'>
              ...
              <option v-for="item in gugunData" :key="item.id" :value='item.id'>{{ item.name }}</option>
            </Select>
          </div>
        </div>
