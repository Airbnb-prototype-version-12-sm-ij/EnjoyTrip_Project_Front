  ...
  <div class="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
    <div class="w-full max-w-7xl px-10 py-15 bg-white rounded-lg shadow-lg dark:bg-gray-800">
      <form class="space-y-10 h-[42rem] mx-auto" enctype="multipart/form-data" @submit.prevent="onSubmit">
        ...
        <div class="mb-6">
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><strong>제목</strong>
            <input type="text" id="title" name="title" v-model='board.title' placeholder="제목을 입력하세요."
              class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          </label>
        </div>


        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><strong>내용</strong>
          <textarea id="content" name="content" placeholder="Enter content" rows="15" v-model="board.content"
