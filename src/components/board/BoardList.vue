...
<template>
  ...
  <div class="ml-[150px]">{{ sidoCode }} {{ gugunCode }} {{ gugunData }}</div>
  <section
    class="mt-[20px] grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 p-4 md:p-6 mx-2 md:mx-6"
    v-show="props.latest"
  >
  ...
  <section
    class="mt-[25px] grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 p-4 md:p-6 mx-2 md:mx-6"
    v-show="!props.latest"
  >
