...
<template>
    <div
        ...
        <div class="bg-white p-4 dark:bg-gray-950">
            <h3 class="font-semibold text-lg md:text-xl group-hover:underline">{{ props.board.title }}</h3>
            <div class='flex justify-between'>
                <p class="text-gray-500 dark:text-gray-400 mt-2">{{ props.board.createdAt.split(' ')[0] }}</p>
